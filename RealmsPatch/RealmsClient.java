...
public class RealmsClient
{
    ...
    public static void switchToProd() {
        RealmsClient.baseUrl = "localhost";
    }
    ...
    public com.mojang.realmsclient.dto.RealmsServerAddress join(final long worldId) throws RealmsServiceException, IOException {
        ...
        return com.mojang.realmsclient.dto.RealmsServerAddress.parse(json);
    }
    
    public void initializeWorld(final long worldId, final String name, final String worldTemplateId) throws RealmsServiceException, IOException {
        final String queryString = QueryBuilder.of("name", name).with("template", worldTemplateId).toQueryString();
    ...
    public UploadInfo upload(final long worldId, final String uploadToken) throws RealmsServiceException {
        ...
        final String content = RealmsClient.gson.toJson((Object)oldUploadInfo);
    ...
    public void sendPingResults(final PingResult pingResult) throws RealmsServiceException {
        ...
        this.execute(Request.post(asciiUrl, RealmsClient.gson.toJson((Object)pingResult)));
    }
    ...
    private String url(final String path, final String queryString) {
        try {
            final URI uri = new URI("http", RealmsClient.baseUrl, "/" + path, queryString, null);
